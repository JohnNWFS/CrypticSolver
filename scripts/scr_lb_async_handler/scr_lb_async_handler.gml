/// @description Shared Async HTTP handler for leaderboard requests.
/// Call from the Async - HTTP event of any object that makes lb requests.
function scr_lb_async_handler() {
